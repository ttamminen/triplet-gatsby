            ...
            <section className="group me-and-what-i-do">
                        ...
                        <section className="text-highlight skills-and-focus">
                            <div className="highlight-content">
                                ...
                                <p>
                                    ...
                                    experienced Web developer, and I have a
                                    plenty of experience on cloud-based SaaS
                                    products.
                                </p>
                            </div>
                        </section>
                ...
                <section className="article-highlight article-highlight-half">
                    <blockquote className="plain frontpage-testimonial">
                        ...
                        encountered. Tatu has great dialogue with design teams,
                        is firm in his front-end skills, and challenges design
                        decisions that will impact the performance and/or
                        usability of large, highly important site.
                    ...
                    <section className="article-highlight mobile-split-half ">
                        ...
                        <div className="highlight-content">
                            ...
                            <p>
                                ...
                                including recruitment into a single, logical
                                entity.
                            </p>
                        </div>
                    </section>
                    <section className="article-highlight">
                        ...
                        <div className="highlight-content">
                            ...
                            <p>
                                ...
                                business software, documents and peoples&#x27;
                                heads into pretty dashboards showing you if
                ...
                <div className="references-wrapper">
                    <section className="article-highlight mobile-split-half">
                        ...
                        <div className="highlight-content">
                            ...
                            <p>
                                Groundbreaking fitness service gathers all of
                                your city’s best sports activities, pop-up
                                training sessions and other fitness activities
                                in one simple and easy to use iPhone app (also
                                now available online). In addition to finding
                                the best activities, Polku enables you to try
                    ...
                    <section className="article-highlight mobile-split-half">
                        ...
                        <div className="highlight-content">
                            ...
                            <p>
                                NordSafety is the new way to collect and share
                                HSEQ information. We&#x27;ve also put a lot a
                                focus on how to engage your staff in safety.
                                With NordSafety you are aware what&#x27;s
                                happening on the field with our photo and
                                information streams. Our mobile app and SaaS
                                service is a perfect fit for high risk or high
                                quality industries, where you&#x27;ll make a
                                difference by knowing what&#x27;s happening on
                        ...
                        <ul className="u-plain-list">
                            <li>
                                <a href="/workshops/mark_seemann">
                                    Mark Seemann - From Design Patterns to
                                    Category Theory
                                </a>
                            </li>
                        </ul>
            ...
            <section className="group">
                <section className="article-highlight article-highlight-half">
                    <div className="highlight-content">
                        ...
                        <p>
                            Thoughts on programming, technology and freelancing
                        </p>
                    </div>
                </section>
            </section>
